...
OUT = ROOT / "reports" / "screenshots" / "phase17_1_live_camera_semantic_hotfix"
...
def prepare_backend_state() -> None:
    ...
    backend_request("POST", "/api/reports/generate-ktr-summary", {"notes": "phase17.1 live camera semantic hotfix evidence"})
...
def main() -> None:
    ...
    try:
        ...
        open_and_capture(session_id, "/", "01_topbar_phase17_build_label.png")
        open_and_capture(
            session_id,
            "/vision",
            "02_vision_mock_surrogate_clear_label.png",
        ...
        open_and_capture(session_id, "/", "03_dashboard_source_kind_clear.png")
        open_and_capture(
            session_id,
            "/self-test",
            "04_self_test_mock_vs_real_camera_checks.png",
        ...
        open_and_capture(session_id, "/reports", "05_reports_camera_source_evidence.png")
        open_and_capture(
            session_id,
            "/logs",
            "06_logs_mock_or_live_surrogate_events.png",
            "const input=document.querySelector('input[placeholder=\"Search type or summary\"]'); if(input){input.value='vision.mock_surrogate'; input.dispatchEvent(new Event('input'));}",
        )
        open_and_capture(
            session_id,
            "/interfaces",
            "07_interfaces_ktr_camera_source_wording.png",
